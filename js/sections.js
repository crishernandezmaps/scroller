  var scrollVis = function() {
    ...
    // We will set the domain when the data is processed. @v4 using new scale names
    var xBarScale = d3.scaleLinear()
      .range([0, width]);

    // The bar chart display is horizontal so we can use an ordinal scale
    ...
    // The histogram display shows the first 30 minutes of data
    ...
    // The color translation uses this scale to convert the progress
    var coughColorScale = d3.scaleLinear()
      .domain([0, 1.0])
      .range(['#008080', 'red']);

    // You could probably get fancy and use just one axis, modifying the scale
    ...
    var setupVis = function(wordData, fillerCounts, histData) {
      ...
      // square grid @v4 Using .merge here to ensure new and old data have same attrs applied
    ...
    /**
     * showAxis - helper function to display particular xAxis
    ...
    /**
     * getFillerWords - returns array of only filler words
